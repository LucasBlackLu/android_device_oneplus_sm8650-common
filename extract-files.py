...
blob_fixups: blob_fixups_user_type = {
    ...
    'vendor/etc/qcril_database/upgrade/config/0006.0_config.sql': blob_fixup()
        .regex_replace(r'persist\.vendor\.radio\.poweron_opt', r'persist.vendor.radio.poweron_ign'),
